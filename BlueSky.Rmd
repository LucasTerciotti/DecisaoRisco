...
##Modelo 1 - Normal
Vamos considerar que dados seguem uma distribuição normal, sem discrimar o dia da semana.
...
Vamos considerar que dados seguem uma distribuição empírica, sem discrimar o dia da semana.
...
56 seria o nível de proteção de assentos.
...
Deixando a tabela de dados mais completa.
...
####Regressao 3: acrescentando uma coluna de feriados (altas demandas)
...
Adicionar feriados e a contagem feriados:days levou à melhor regressão até o momento (regressão 4), pela avaliação dos resíduos, do RMSE e do valor de Rsquared.
